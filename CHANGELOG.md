...
- **Encoding Error in Cache**: Fixed encoding issue in `map_generator.py` when calculating file hash for cache validation. Now properly handles non-UTF-8 files (Latin-1, CP1252, GBK) during cache operations.
